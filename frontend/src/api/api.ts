...
/**
 * event _segmentation report type main payload
 * @export
...
/**
 * time spent after the first use of event. Use in _segmentation
 * @export
...
/**
 * window operation for _segmentation. Tells that event should be triggered each timeunit (each day, for instance) {   \"time\": {     \"type\": \"windowEach\",     \"unit\":\"day\"   } }
 * @export
...
export const QueryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Event _segmentation query
         * @param {number} organizationId 
         * @param {number} projectId 
