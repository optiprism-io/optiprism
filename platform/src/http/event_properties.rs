use crate::event_properties::Provider;
...
) -> Result<Json<ListResponse<EventProperty>>> {
...
pub fn configure(router: Router) -> Router {
    router
        ...
        .route(
            "/v1/projects/:project_id/events/event_properties/:prop_name",
