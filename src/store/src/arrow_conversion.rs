...
pub fn arrow2_to_arrow1(arr2: Box<dyn arrow2::array::Array>, field: arrow2::datatypes::Field) -> Result<arrow_array::ArrayRef> {
    ...
    Ok(arrow_array::make_array(arrow::ffi::ArrowArray::new(arr1_ffi, schema1_ffi).try_into()?))
}